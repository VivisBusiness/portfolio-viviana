export const es = {
  ...
  projects: {
    ...
    verzalo: {
      title: 'Verzalo',
      description: 'Verzalo es una plataforma eCommerce construida como un monorepo con Angular, NestJS y MongoDB, optimizada para una experiencia de compra eficiente y escalable.'
    },
    personalPortfolio: {
  ...
  contact: {
    ...
    gitHub: "Explora mis repositorios en GitHub",
    email: "Envíame un correo",
    CodePen: "Mira mis snippets en CodePen"
  },
  footer: {
